...
const WhatsAppChatButton: React.FC<WhatsAppChatButtonProps> = ({ phoneNumber }) => {
    const message = "Bonjour INZASTORE, j'ai une question.";
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 bg-green-500 text-white rounded-full p-4 shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-110 z-40"
